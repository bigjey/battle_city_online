...
import { BlockType, Command, DIR, KEYS } from "../constants";
import type { Block } from "../shared/gameplay/Block";
import { levels } from "../shared/levels";
import { buildLevel } from "../utils/level";

export class ServerGame implements ILocalGame {
  ...
  processCommand(command: Command, commandParams: CommandParams<Command>) {
    switch (command) {
